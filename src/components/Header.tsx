...
import { Dimensions, StyleProp, useWindowDimensions, ViewStyle } from 'react-native';
...
const Header: React.FC<HeaderProps> = ({elevated, backgroundColor, barStyle, containerStyle, leftComponent, leftContainerStyle, centerComponent, centerContainerStyle, rightComponent, rightContainerStyle}) => {
