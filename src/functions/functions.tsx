...
export const toast = (type: TOAST_TYPE|null, message: string, close: boolean|number = true, title: string|undefined = undefined) => {
    // @ts-ignore
    Toast.show({
        // @ts-ignore
...
export const host = PRODUCTION ? 'https://mobile.utechaway.com' : 'http://192.168.8.101:80/sources/utechaway-htdocs/mobile.utechaway.com';

export const baseUri = PRODUCTION ? 'https://utechaway.com/assets' : 'http://192.168.8.101:80/sources/utechaway-htdocs/utechaway.com/assets';

export const fetchUri =  host+'/admin-request.php';

// : baseUri + '/mobile/request.php';