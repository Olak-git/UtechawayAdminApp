...
export const Teams: React.FC<TeamsProps> = ({ endFetch, teams, refreshing, onRefresh, navigation, user, setImageSelected, setVisible, emptyMessage }) => {

    // @ts-ignore
    const renderItem = ({ item }) => (
        <RenderUser navigation={navigation} item={item} setImageSelected={setImageSelected} setVisible={setVisible} account={'collaborateur'} />
    )
